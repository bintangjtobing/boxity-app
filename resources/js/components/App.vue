      ...
      <nav class="navbar navbar-light">
        <div class="navbar-left">
          ...
          <a class="navbar-brand" href="/tools"
            ><img
              class="svg dark"
              :src="'./dashboard/img/Logo_Dark.png'"
              alt="logo BTSA Logistics" /><img
              class="light"
              :src="'./dashboard/img/Logo_white.png'"
              alt="logo BTSA Logistics"
          /></a>
          <div>
        ...
        <div class="navbar-right">
          <ul class="navbar-right__menu">
            <li>
              <button class="btn" onclick="turnOnDarkMode()">
                <span>
        ...
        <div class="sidebar__menu-group">
          <ul class="sidebar_nav">
            <div v-if="user.role != 'customer'">
              ...
              <li>
                <router-link to="/goods-receipt">
                  <span class="material-icons-outlined nav-icon"> feed </span>
                  <span class="menu-text">Goods receipt</span>
                </router-link>
              </li>
              <li>
                <router-link to="/quote">
                  <span class="material-icons-outlined nav-icon"> book </span>
            ...
            <div v-if="user.role == 'customer' || user.role == 'admin'">
              ...
              <li>
                <router-link :to="'/warehouse-list'">
                  ...
                  <span class="badge badge-secondary text-white menuItem"
                    >RTL</span
                  >
                </router-link>
              </li>
              ...
              <li>
                <router-link :to="'/stock-group'">
                  ...
                  <span class="menu-text"> Stock Group </span>
                  <span class="badge badge-secondary text-white menuItem"
                    >RTL</span
                  >
                </router-link>
            ...
            <div v-if="user.role == 'it' || user.role == 'admin'">
              ...
              <li>
                <router-link to="/user-guide">
                  <span class="material-icons-outlined nav-icon"> help </span>
            ...
            <li>
              ...
              <a :href="'/api/logs'">
                <span class="material-icons-outlined nav-icon"> report </span>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="footer-copyright">
                <p>
                  &copy; Copyright -<a href="/" target="_blank"
                    ><abbr title="PT BERLIAN TRANSTAR ABADI">{{
                      company.company_name
                    }}</abbr></a
                  >
                  | Partner with
                  <abbr title="PT BENUA SOLUSI TEKNOLOGI"
                    ><a href="https://infinitysolutions.co.id" target="_blank"
                      >Infinity Solutions</a
                    ></abbr
                  >
                </p>
              </div>
              ...
              <div class="footer-menu text-right">
                <ul>
                  <li>
                    ...
                    >
                      App version {{ version.version }}</router-link
                    >
                  </li>
                </ul>
              </div>
