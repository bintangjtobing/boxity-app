            ...
            <div class="modal-body">
              <form>
                <div class="form-row">
                  <div class="col-lg-4">
                    <div class="form-group mb-10">
                      <input
                        type="text"
                        v-model="warehouse.warehouse_code"
                ...
                <div class="form-group mt-1">
                  <editor
                    placeholder="Warehouse address here..."
