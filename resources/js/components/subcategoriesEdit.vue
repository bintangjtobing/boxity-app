        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="breadcrumb-main">
                    <h2 class="text-capitalize fw-700 breadcrumb-title">Edit Sub Category</h2>
                </div>
            </div>
        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" v-model="subcategories.sub_categories_name"
                        ...
                        <div class="card-body pb-md-30">
                            <div class="Vertical-form">
                                <div class="form-group my-2">
                                    ...
                                    <img :src="subcategories.image.file" :alt="subcategories.sub_categories_name"
                                        class="img-fluid">
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.loadDataSubCategories();
            this.getSubCategories();
        },
        methods: {
            async loadDataSubCategories() {
                // this.$Progress.start();
                this.$isLoading(true);
                const resp = await axios.get('/api/sub-categories/' + this.$route.params.id);
            ...
            async submitHandle() {
                // this.$Progress.start();
                this.$isLoading(true);
                await axios.patch('/api/sub-categories/' + this.$route.params.id, this.subcategories);
                document.getElementById('ding').play();
                Swal.fire({
                    icon: 'success',
                    title: 'Congratulations',
                    text: 'Success update subcategories.',
                });
                // this.$Progress.finish();
                this.$isLoading(false);
