                        ...
                        <div v-show="isShow.colapse">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <span>Unit:</span>
                                        <input type="text" v-model="itemAdd.unit" id="" class="form-control" required
                                            readonly :disabled="isDisable.input" />
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" v-model="itemAdd.price" class="form-control" min="0.00"
                                            max="10000.00" step="0.01" readonly :disabled="isDisable.input" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea v-model="itemAdd.remarks" class="form-control" id="" cols="30"
                                            rows="2" :disabled="isDisable.input"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <div class="form-group col-lg-5">
                                            <span>From warehouse:</span>
                                            <input type="text" v-model="itemModify.warehouse_name" id=""
                            ...
                            <div class="table-responsive">
                                ...
                                <v-data-table :search="search" :headers="headers" :items="itemSalesData"
                                    ...
                                    <template v-slot:item.actions="{ item }">
                                        <button v-on:click="modifyItemPurchasing(item.id)" class="edit">
                                            <i class="fad fa-edit"></i>
                                        </button>
                                        <button v-on:click="deleteItemPurchasing(item.id)" class="remove">
                      ...
                      placeholder: 'Select Item',
                        ...
                        <div class="form-row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <span>Remarks:</span>
                                    <textarea class="form-control" v-model="salesOrderData.remarks" cols="30" rows="4"
                            ...
                            <div class="row">
                                <div class="col-5 text-left">
                                    <div class="checkbox-theme-default custom-checkbox">
                                        <input v-model="isEdit" class="checkbox" type="checkbox" id="check-1" />
                                        <label for="check-1">
                                ...
                                <div class="col-12">
                                    <a :href="`/api/report/sales-order/${this.$route.params.so_number}`" class="
                      btn btn-secondary
                      float-right
