        ...
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Sales Delivery Receipt<br></h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        <div class="action-btn">
                            <a href="#" data-toggle="modal" data-target="#addSalesDeliveryReceipt"
                                class="btn btn-sm btn-primary btn-add">
                                <i class="las la-plus fs-16"></i>Add New Sales Delivery Receipt</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="addSalesDeliveryReceipt" tabindex="-1" aria-labelledby="addSalesDeliveryReceipt"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title fw-500" id="staticBackdropLabel">Add Sales Delivery Receipt</h6>
