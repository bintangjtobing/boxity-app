<template>
    <div>
        <div class="row mt-4">
                ...
                <div class="breadcrumb-main">
                    ...
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        <div class="action-btn">
                            <a href="#" data-toggle="modal" data-target="#addPurchaseOrder"
                                class="btn btn-sm btn-primary btn-add">
                                <i class="las la-plus fs-16"></i>Add New Purchase Order</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="addPurchaseOrder" tabindex="-1" aria-labelledby="addPurchaseOrder"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title fw-500" id="staticBackdropLabel">Add New Purchase Order</h6>
