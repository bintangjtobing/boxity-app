                ...
                <div class="breadcrumb-main user-member justify-content-sm-between ">
                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                        <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                            <h4 class="text-capitalize fw-500 breadcrumb-title">Add New Purchase Invoices</h4>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        title() {
            return `Add New Purchase Invoices`;
        },
        data() {
            return {
                inventorydata: {},
        ...
        methods: {
            ...
            async handleSubmit() {
                ...
                Swal.fire({
                    ...
                    text: 'Success update Purchase Invoices data',
                });
