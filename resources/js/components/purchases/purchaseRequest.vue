        ...
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    ...
                    <div class="breadcrumb-action justify-content-center flex-wrap" v-if="permissions.includes('CreatePurchaseRequest')">
                            ...
                            <div class="table-responsive">
                                ...
                                <v-data-table :search="search" loading loading-text="Loading... Please wait..."
                                    ...
                                    <template v-slot:[`item.actions`]="{item}">
                                        ...
                                        <a v-on:click="deletePurchaseRequestItem(item.id)" class="remove" v-if="permissions.includes('DeletePurchaseRequest')">
