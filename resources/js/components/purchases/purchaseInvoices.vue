        ...
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Purchase Invoices<br></h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        <div class="action-btn">
                            <a href="#" data-toggle="modal" data-target="#addPurchaseInvoices"
                                class="btn btn-sm btn-primary btn-add">
                                <i class="las la-plus fs-16"></i>Add New Purchase Invoices</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="addPurchaseInvoices" tabindex="-1" aria-labelledby="addPurchaseInvoices"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title fw-500" id="staticBackdropLabel">Add Purchase Invoices</h6>
            ...
            async submitHandle() {
                ...
                await axios.post('/api/inventory-item', this.inventorydata).then(response => {
                    ...
                    Swal.fire({
                        ...
                        text: 'Success add Purchase Invoices',
                    });
                    this.inventorydata = {
                        item_code: '',
                        item_name: '',
