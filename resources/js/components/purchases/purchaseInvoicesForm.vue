                ...
                <div class="breadcrumb-main user-member justify-content-sm-between ">
                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                        <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                            <h4 class="text-capitalize fw-500 breadcrumb-title">Purchase Invoice
                                #{{purchaseInvoiceData.pi_number}}</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div v-show="isShow.colapse">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input v-bind:disabled="checkedItem === false" type="text"
                                            v-model="itemModify.customer" id="" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <span>Warehouse:</span>
                                        <input v-bind:disabled="checkedItem === false" type="text"
                                            v-model="itemModify.warehouse" id="" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <span>Price:</span>
                                        <input type="number" v-model="itemModify.currentPrice" @change="onPriceChange"
                                            @input="onPriceChange" class="form-control" min="0" max="9999999" step="250"
                                            :disabled="isWriteForm" />
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <span>Supplier:</span>
                                    <select v-bind:disabled="checkedPI === false" v-model="purchaseInvoiceData.supplier"
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input v-bind:disabled="checkedPI === false" type="date"
                                        v-model="purchaseInvoiceData.invoice_date" class="form-control"
                                        placeholder="Brand">
                                </div>
                            </div>
                            <!--
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select v-bind:disabled="checkedPI === false"
                                        v-model="purchaseInvoiceData.deliver_to"
                                        class="form-control form-control-default">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-bind:disabled="checkedPI === false"
                                        v-model="purchaseInvoiceData.drivers" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <span>Vehicle No:</span>
                                    <input type="text" v-bind:disabled="checkedPI === false"
                                        v-model="purchaseInvoiceData.vehicle_no" class="form-control"
                                        placeholder="ex: BK 0000 ABC">
                                </div>
                            </div>
                            -->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            activeAddForm() {
                window.scrollTo(0, 0);
                this.titleItemDescription = 'Add Purchase Invoice Items';
            ...
            async modifyItemPurchasing(id) {
                ...
                this.itemModify.weightIn = resp.data.weightIn;
                this.itemModify.weightOut = resp.data.weightOut;
                this.itemModify.qtyShipped = resp.data.qtyShipped;
                this.itemModify.unit = resp.data.unit;
                this.itemModify.purpose = resp.data.purpose;
                this.itemModify.driver_name = resp.data.driver_name;
                this.itemModify.driver_nopol = resp.data.driver_nopol;
                this.itemModify.remarks = resp.data.remarks;
