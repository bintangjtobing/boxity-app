...
<body class="my-login-page">
    <section class="h-100">
            ...
            <div class="col-6 mx-auto mt-5">
                    <div class="">
                    <img style="height: 350px" src="{!!asset('auth/img/illustration.png')!!}" alt="boxity + {{$company->company_id}}">
                    </div>
                </div>
                ...
                <div class="">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="/login/{{csrf_token()}}">
                                ...
                                <div class="form-group bg-input-new px-2 py-2 rounded">
                                    ...
                                    <input id="email" type="email" class="form-control input-style" style="border: none; background: transparent"  name="email" value="" required
                                ...
                                <label for="password" class="text-secondary">Password</label>
                                    <input id="password" type="password" class="form-control input-style" style="border: none; background: transparent" name="password" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 text-right">
                                        <label for="password">
                                            <a href="/forgot-password" class="text-right text-secondary" style="text-decoration: none">
                                ...
                                <div class="form-group m-0">
                                    <button type="submit" class="btn bg-orange btn-block py-4 px-3 text-white font-weight-bold">
                                        Sign In
                                    </button>
                                </div>
                            </form>
                    ...
                    <div class="footer">
                    &copy; <?php $y = date('Y'); ?> Boxity Central Indonesia partner <br>
                        with {{$company->company_name}}.<br>
                        All Rights Reserved. Web App Version 1.0.5<br>
                        <!-- <?php $y = date('Y'); ?>
