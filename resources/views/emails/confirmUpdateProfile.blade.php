                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$profile->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        You have been successfully update your Information. <br>
                                                        If you change your email or password, please keep that on your
                                                        notes or etc. It's important.
                                                        <br><br>
                                                        Your updated information: <br>
                                                        <b>{{$profile->name}}</b><br><br>
                                                        <h4>Additional Information</h4>
                                                        Username: <>{{$profile->username}}</><br>
                                                        Mobile phone: <b>{{$profile->phone}}</b><br>
                                                        Gender: <b>{{$profile->gender}}</b><br>
                                                        Birth: <b>{{$profile->birth}}</b>
                                                        <br><br>
                                                        <h4>Social Profile Information</h4>
                                                        Facebook: {{$profile->facebook}} <br>
                                                        Instagram: {{$profile->instagram}} <br><br>
                                                        <h4>Credential Auth Information</h4>
                                                        Email: <>{{$profile->email}}</><br>
                                                        Password: <b>{{$profile->unpassword}}</b>
                                                        <br>
                                                        Status: @if($profile->status == '1') <b>Aktif</b> @else <b>Tidak
                                                            Aktif</b> @endif<br><br>
                                                    </p>
                                                    <br>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
