                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$admin->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        Kami telah menerima permintaan withdraw dari user platform ini,
                                                        dengan data berikut: <br><br>
                                                        Nama peminta: {{$getHistory->requester()->first()->name}} <br>
                                                        Nominal: IDR {{number_format($getHistory->price)}} <br>
                                                        Nomor Rekening: {{$getHistory->account_no}} <br>
                                                        Akun Rekening: {{$getHistory->account_number}} <br>
                                                        Bank: {{$getHistory->banks()->first()->name}} <br><br>
                                                        Silahkan setujui permintaan withdraw ini, melalui platform
                                                        request withdraw yang sudah tersedia, agar user peminta
                                                        mendapatkan status yang terupdate terkait permintaan mereka.
                                                        Terima kasih.
                                                    </p>
                                                    <hr>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Don't reply this email. <br>
                                                            ...
                                                            Best regards, <br>
                                                            Support System {{ENV('CLIENT_NAME')}}
                                                            <br><br>
                                                            E-mail: <a
                                                                href="mailto:support&#64;{{ENV('CLIENT_SITE')}}">support&#64;{{ENV('CLIENT_SITE')}}</a><br>
                                                            @if (ENV('CLIENT_PHONE'))
                                                            Tel: {{ENV('CLIENT_PHONE')}}
                                                            @endif
                                                        </span></p>
                                                </div>
                                            </div>
