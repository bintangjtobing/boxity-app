                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$user->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        You have been successfully reset your password. <br>
                                                        Please save your email and password on your notepad or your
                                                        phone.
                                                    </p>
                                                </div>
                                            </div>
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style=""><strong>Terima kasih atas
                                                                perhatiannya
                                                                ya.</strong><br>
                                                            Reset Password BTSA Logistics <br>
                                                            support@btsa.co.id <br></span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
