                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$admin->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span>Kami telah menerima konten terbaru.<br><br>
                                                            Yang membuat
                                                            konten
                                                            ini: <br>
                                                            <br>
                                                            Nama Pembuat: {{$blogs->user()->first()->name}}<br>
                                                            Email: <a
                                                                href="mailto:{{$blogs->user()->first()->email}}?subject=Re:[Content#{{$blogs->id}}] "
                                                                target="_top">{{$blogs->user()->first()->email}}</a>
                                                            <br>
                                                            @if ($blogs->status=='0')
                                                            <span
                                                                style="color:red; background-color:rgba(132, 251, 167, 0)">Konten
                                                                ini belum disetujui.</span>
                                                            @endif<br><br>
                                                            Mohon ditindak lanjuti konten dengan nomor antrian
                                                            #00{{$blogs->id}} yang
                                                            berisi mengenai:
                                                            <br>
                                                            <b>{{$blogs->title}}</b>
