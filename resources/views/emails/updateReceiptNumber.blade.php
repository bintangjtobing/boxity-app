                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$documentRelated->sender->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        Dokumen kamu sudah ada nomor resi nya nih. Kamu boleh cek
                                                        langsung ke situs ekpedisi untuk tracking dokumen nya ya. <br>
                                                        <br>
                                                        Berikut informasi dokumennya: <br>
                                                        Nomor resi: {{$ItemDelivering->receiptNumber}} <br>
                                                        Tujuan: {{$ItemDelivering->destination}} <br>
                                                        Catatan: {{$ItemDelivering->remarks}}
                                                    </p>
                                                    <br>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
