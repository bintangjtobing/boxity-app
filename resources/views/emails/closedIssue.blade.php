                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$issues->user()->first()->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span>Kami telah menyelesakan laporan issue kamu.<br><br>
                                                            Yang menyelesaikan
                                                            mengenai laporan
                                                            ini: <br>
                                                            <br>
                                                            Nama penyelesai: {{$issues->assigne()->first()->name}}<br>
                                                            Email penyelesai: <a
                                                                href="mailto:{{$issues->assigne()->first()->email}}?subject=Re:[Ticket#{{$issues->id}}] Important: Issue Report have been made to our systems."
                                                                target="_top">{{$issues->assigne()->first()->email}}</a>
                                                            <br><br>
                                                            Kamu yang melapor dengan nomor antrian
                                                            #{{$issues->id}} yang
                                                            berisi mengenai:
                                                            <br>
                                                            <b>{{$issues->title}}</b>
                                                    ...
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        ...
                                                        tersedia: <br>
                                                        <span><a href="https://{{$company->site}}/tools/issues/{{$issues->id}} "
                                                                target="_blank">https://{{$company->site}}/tools/issues/{{$issues->id}}</a></span>
                                                    </p>
                                                    <br>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
