                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$user->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        Admin have been successfully update your Information. <br>
                                                        If admin change your email or password, please keep that on your
                                                        notes or etc. It's important.
                                                        <br><br>
                                                        Your updated information: <br>
                                                        <b>{{$user->name}}</b><br>
                                                        Email: <b>{{$user->email}}</b><br>
                                                        Password: <b>{{$user->unpassword}}</b>
                                                        <br>
                                                        Status: @if($user->status == '1') <b>Aktif</b> @else <b>Tidak
                                                            Aktif</b> @endif<br><br>
                                                    </p>
                                                    <br>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
