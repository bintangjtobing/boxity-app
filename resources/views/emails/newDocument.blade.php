                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        Halo, dokumen delivery yang baru telah terbit.
                                                        Mohon dibantu untuk diproses ya.
                                                        <br><br>
                                                        Berikut informasi dokumen nya: <br>
                                                        Nomor resi permintaan dokumen: {{$ddrGet->ddr_number}} <br>
                                                        Dibuat oleh: {{$ddrGet->sender->name}} <br>
                                                        <br>
                                                        <br>
                                                        Terima kasih ya.
                                                    </p>
