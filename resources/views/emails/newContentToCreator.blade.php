                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hallo
                                                            {{$creator->name}},</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span>Kami telah menerima konten terbaru kamu yang berjudul
                                                            <b>{{$blogs->title}}</b>, saat ini, kamu hanya tinggal
                                                            menunggu persetujuan dari administrator / moderator
                                                            {{ENV('CLIENT_SITE')}} saja. <br> Dan kami akan segera
                                                            kabari apabila konten kamu memiliki status terbaru ya.
                                                        </span>
                                                    </p>
                                                    <hr>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
