        ...
        <table border="0" cellspacing="0" cellpadding="0">
          ...
          ?>
                <tr style="font-size: 12px; color: #190902;">
                    ...
                    <td style="width: auto;text-align: center">{{ $item['qty'] }} {{ $item['unit'] }}</td>
                    <td style="width: 20%;text-align: center">Rp. {{ number_format($item['price'],2) }}</td>
                    <td style="width: auto; text-align: center">{{ $item['remark'] }}</td>
            ...
            <tfoot style="font-size: 12px; color: #190902;">
                <tr>
                    <td colspan="2" rowspan="3" style="text-align: left !important; vertical-align: top; ">
                        ...
                        <div style="font-size: 12px; font-weight:700; color: #190902;">{{$bankPaymentName}}
                        </div>
                        <div style="font-size: 12px; color: #190902;">{{$bankPaymentAccountName}}</div>
                        <div style="font-size: 12px; color: #190902;">{{$bankPaymentNo}}</div>
                    </td>
                    <td></td>
