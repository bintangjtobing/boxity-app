        ...
        <table border="0" cellspacing="0" cellpadding="0">
          ...
          ?>
                <tr style="font-size: 12px; color: #190902;">
                    ...
                    <td style="width: auto;text-align: left">{{ $item['qty'] }} {{ $item['unit'] }}</td>
                    <td style="width: 20%;text-align: left">Rp. {{ number_format($item['price'],2) }}</td>
                    <td style="width: auto; text-align: left">{{ $item['remark'] }}</td>
