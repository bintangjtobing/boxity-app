...
class approveIssueNotification extends Notification
{
    ...
    public function toTelegram($notifiable)
    {
        ...
        return TelegramMessage::create()
            ...
            ->to($notifiable->assigne->telegram_id)
            // Markdown supported.
            ->content("Halo " . $this->issues->assigne->name . ", Kami telah menerima laporan issue nomor #" . $this->issues->id . " mengenai sistem/program/jaringan sistem perusahaan. Berikut ini yang melapor issue tersebut:

            Nama pelapor : " . $this->issues->user->name . "
            Email pelapor : " . $this->issues->user->email . "
            Judul Issue : " . $this->issues->title)
